...
1. 아래 링크에서 ZIP 파일을 다운로드합니다.

   **[⬇ PPEditer-v1.9.0-win-x64.zip](https://github.com/elrang3843/PPEditer/releases/download/v1.9.0/PPEditer-v1.9.0-win-x64.zip)** (약 73 MB)

   또는 [Releases](https://github.com/elrang3843/PPEditer/releases) 페이지에서 최신 버전을 확인하세요.

2. ZIP 파일을 원하는 폴더에 압축 해제합니다.
3. 압축 해제된 폴더 안의 `PPEditer.exe`를 더블클릭하여 실행합니다.

> **설치 프로그램 없음** — 압축만 풀면 바로 실행됩니다.  
> **Self-contained 빌드** — .NET을 별도로 설치할 필요 없습니다.

#### 무결성 확인 (선택)

다운로드한 파일이 변조되지 않았는지 확인하려면 PowerShell에서 아래 명령을 실행하세요.

```powershell
Get-FileHash PPEditer-v1.9.0-win-x64.zip -Algorithm SHA256
```

| 항목 | 값 |
|------|----|
| 알고리즘 | SHA256 |
| 해시 | `5DFF8216B83595EA7EBF9FA883231BBD0522648E9DF1FF223FDEEE22B1DBD29D` |
...
1. Download the ZIP from the link below.
   ...
   **[⬇ PPEditer-v1.9.0-win-x64.zip](https://github.com/elrang3843/PPEditer/releases/download/v1.9.0/PPEditer-v1.9.0-win-x64.zip)** (~73 MB)

   Or check the [Releases](https://github.com/elrang3843/PPEditer/releases) page for the latest version.

2. Extract the ZIP to any folder.
3. Double-click `PPEditer.exe` inside the extracted folder to launch.
...
Verify the download has not been tampered with by running this in PowerShell:
...
|-------|-------|
| Algorithm | SHA256 |
| Hash | `5DFF8216B83595EA7EBF9FA883231BBD0522648E9DF1FF223FDEEE22B1DBD29D` |

#### Option 2 — Associate with .pptx Files (Optional)
